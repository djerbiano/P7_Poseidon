...
/**
 * Objet de transfert représentant les champs d'un Trade saisis dans les
 * formulaires d'ajout et de modification. Seuls ces champs peuvent être
 * liés depuis une requête HTTP, ce qui protège les autres colonnes de
 * l'entité contre le Mass Assignment.
 * <p>
